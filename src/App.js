      ...
      <div className='content'>
          ...
          <div className='toggle-div'>
            ...
            <label className="switch">
              <input onClick={changeState} type="checkbox" />
          ...
          { cardState ?
            ...
            upload = 'Send up to 3GB' />

            <Card
            width={window.innerWidth < 768 ? '80%': '20%'}
            height={window.innerWidth < 768 ? '350px':'400px' }
            bgcolor='linear-gradient(hsl(236, 72%, 79%), hsl(237, 63%, 64%))'
            textColor='white'
            btnbg='linear-gradient( white, white)'
            btntext='hsl(237, 63%, 64%)'
            plan = 'Professional'
            price = '$249.99'
            storage='1 TB Storage'
            user = '5 Users Allowed'
            upload = 'Send up to 10GB' />
